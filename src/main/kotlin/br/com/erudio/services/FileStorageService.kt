...
class FileStorageService @Autowired constructor(fileStorageConfig: FileStorageConfig) {
    ...
    init {
        ...
        try {
            ...
            throw FileStorageException("Cold not create the directory where the uploaded files will be stored", e)
        }
    }
    fun storeFile(file: MultipartFile): String {
        ...
        return try {
            ...
            throw FileStorageException("Cold not store file $fileName. Please try again!", e)
        }
    }
